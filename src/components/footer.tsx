...
export function Footer() {
  // Add state for mail copy feedback
  const [mailCopied, setMailCopied] = useState(false);

  // Handler to copy mail to clipboard
    ...
    <footer className="bg-white border-t border-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-sans text-base font-medium text-gray-900 mb-4">Quick Links</h4>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <button
                ...
                className="text-gray-500 hover:text-sparrow-brown transition-colors focus:outline-none"
                title="Copy email"
                type="button"
              >
                <span className="sr-only">Mail</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M2.25 4.5A2.25 2.25 0 0 1 4.5 2.25h15a2.25 2.25 0 0 1 2.25 2.25v15a2.25 2.25 0 0 1-2.25 2.25h-15A2.25 2.25 0 0 1 2.25 19.5v-15zm1.5 0v.638l8.25 6.187 8.25-6.187V4.5a.75.75 0 0 0-.75-.75h-15a.75.75 0 0 0-.75.75zm16.5 2.322-7.728 5.797a.75.75 0 0 1-.894 0L3.75 6.822V19.5a.75.75 0 0 0 .75.75h15a.75.75 0 0 0 .75-.75V6.822z"/>
                </svg>
              </button>
              {mailCopied && (
