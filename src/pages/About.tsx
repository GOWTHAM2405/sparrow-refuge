  ...
  return (
    <PageLayout>
      <HeroSection
        ...
        imageUrl="https://images.unsplash.com/photo-1507608158173-1dcec673a2e5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80"
        imageAlt="Person looking at sparrows in an urban setting"
      ...
      <StorySection
        title="The Team Behind Sparrow Refugee"
        content="Our team brings together diverse expertise in urban ecology, ornithology, sustainable design, and community engagement. We're united by our passion for creating cities that are hospitable to both humans and wildlife."
      ...
      >
        <p className="text-base md:text-lg text-gray-700">
          From field researchers tracking sparrow populations to designers developing the Sparrow Nest, 
          each team member contributes unique skills to our mission. We also work closely with a network of 
          volunteers, community scientists, and local partners who help extend our impact.
        </p>
      </StorySection>
